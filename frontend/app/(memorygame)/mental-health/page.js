...
const AnxietyCards = [
  {
    ...
    title: "General Worry",
    description:
      "Experiencing constant and excessive worrying about various aspects of life.",
  ...
  },
  {
    ...
    description:
      "Feeling anxious or fearful in social situations, often accompanied by self-consciousness.",
  ...
  },
  {
    ...
    title: "Perfectionism",
    description:
      "Setting unrealistically high standards for oneself and feeling stressed when they are not met.",
  },
  {
    id: 4,
    title: "Panic",
    description:
      "Sudden and intense episodes of fear, often accompanied by physical symptoms like heart palpitations.",
  },
  {
    id: 5,
    title: "Phobias",
...
const ToolsSection = [
  ...
  },
  {
    ...
    description:
      "Explore techniques for cultivating positive and healthy thought patterns.",
    link: "/mental-health/healthy-thinking", // Replace with the actual route for healthy thinking
  },
  {
    id: 3,
    title: "Chill Zone",
    description:
      "Find a relaxing space with calming activities to help alleviate stress.",
  ...
  },
  {
    ...
    title: "Taking Action",
    description:
      "Learn strategies to take proactive steps towards managing anxiety.",
    ...
    <div className="flex justify-center">
      <div>
        ...
        <p className="text-lg font-semibold mb-6">
          Choose a tool to manage your Anxiety
        </p>
